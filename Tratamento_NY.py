...
def normalizacao(new_york_sOutliers, arquivo_csv='Ficheiros_Normalizados/NY_data_normalizado.csv'):
    """This function normalizes the data."""
    scaler = MinMaxScaler()
    new_york_normalizado = new_york_sOutliers.copy()
...
# new_york_sOutliers = new_york.copy()
